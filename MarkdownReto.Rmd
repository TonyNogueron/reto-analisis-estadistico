...
```{r}
productoA.ts.desc = decompose(productoA); plot(productoA.ts.desc,xlab = "Año",main="Producto A")

productoB.ts.desc = decompose(productoB); plot(productoB.ts.desc,xlab = "Año",main="Producto B")

productoC.ts.desc = decompose(productoC); plot(productoC.ts.desc,xlab = "Año",main="Producto C")
```
...
plot(productoA.des,main="Año",main="Producto A")
productoB.des = productoB-productoB.ts.desc$seasonal
plot(productoB.des,main="Año",main="Producto B")
productoC.des = productoC-productoC.ts.desc$seasonal
plot(productoC.des,main="Año",main="Producto C")
```
...
```{r}
# FUNCIONES DE AUTOCOVARIANZAS Y DE AUTOCORRELACIONES
yA = difA2.difA.x; acf(yA,main="Producto A")
yB = difB2.difB.x; acf(yB,main="Producto B")
yC = difC2.difC.x; acf(yC.main="Producto C")
```
