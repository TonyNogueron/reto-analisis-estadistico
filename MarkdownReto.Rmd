...
El modelo sin las variables mencionadas anteriormente, tiene un R de 0.7293, lo que nos indica que es capaz de explicar el 72.93% de la variabilidad observada en el porcentaje de defectos.
...
El modelo sin las variables mencionadas anteriormente, tiene un R de 0.7115, lo que nos indica que es capaz de explicar el 71.15% de la variabilidad observada en el porcentaje de defectos.
...
El modelo con las variables con un valor p menor a 0.05, tiene un R de 0.7101, lo que nos indica que es capaz de explicar el 71.01% de la variabilidad observada en el porcentaje de defectos.
...
# Búsqueda del mejor modelo para analizar la situación problema
